...
benchmark_ddm <- function(n_runs = 100, compare_with_r = TRUE, include_custom_noise = FALSE) {
  ...
  # Define custom noise function for testing (simple normal noise equivalent)
